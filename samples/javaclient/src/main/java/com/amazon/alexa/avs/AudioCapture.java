...
public class AudioCapture {
	...
	log.info( "audio Frame Size: " + FRAME_SIZE_IN_BYTES );
	log.info( "audio Buffer Size: " + BUFFER_SIZE_IN_BYTES );
    }
    ...
    private class AudioBufferThread extends Thread {
	    ...
	    int available_size = microphoneLine.available( );
	    int size = ( ( microphoneLine.getBufferSize() / 5 ) / FRAME_SIZE_IN_BYTES ) * FRAME_SIZE_IN_BYTES;
	    log.info( "audio available Size: " + available_size );
	    log.info( "audio Size: " + size );
